class Form {
  constructor () {
    ...
    this.descriptionInputWithError = this.self.element(by.id('.field_with_errors #destination_description'))
    this.updateButton = this.self.element(by.id('input[type="submit"]'))
  }
